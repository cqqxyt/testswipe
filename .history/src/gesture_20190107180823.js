...
class gesture  {
    ...
    _onDragStart(e){
        ...
        var startPointsList = _that._getTouchPoints(e),
            ...
            if(!_isDragging){
                _isDragging = true
                _that._equalizePoints(_startPanOffset, _panOffset);

			    _currPanDist.x = _currPanDist.y = 0;
			    utli._equalizePoints(_currPoint, startPointsList[0]);
                utli._equalizePoints(_startPoint, _currPoint);
            console.log(_currPoint)
